...
FILES='tmux.conf vim xsession Xdefaults gitconfig editrc inputrc shrc profile'
...
printf "cp ~/dev/kamailio/github.com/kamailio/vim-kamailio-autocomplete/plugin/* vim/plugin/\n"
